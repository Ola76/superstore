...
# Check if a file is uploaded or use the default dataset
if uploaded_file:
...
st.markdown("<h1 style='text-align: center; color: lightblue; font-family: cursive;'>Products Descriptions</h1>", unsafe_allow_html=True)
...
show_states = st.checkbox('Show States instead of Regions', key="unique_checkbox_key")
...
option = st.radio('Choose a view:', ('day_of_week_num', 'month', 'order_month_year'))
...
if order_id_search:
    ...
    if not matched_data.empty:
        ...
        # Convert matched data to CSV and provide download link
